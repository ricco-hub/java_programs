...
{
    public int[][] playerMatrix = new int[8][8];   //Stores which player is in a cell. 0 empty, 1 player one, 2 player two
    public static int[][] pieceMatrix = new int[8][8];    //Stores which piece is in a cell. 0 pawn, 1 rook, 2 knight, 3 bishop, 4 queen, 5 king, 6 empty
    int pawnCount = -2;
