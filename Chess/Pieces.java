...
public class Pieces extends objChessBoard
{
    protected int finalDesRow = 0;
    protected int finalDesColumn = 0;

    public objCellMatrix cellMatrix = new objCellMatrix();
    ...
    {
        if (straightAxis) //Moving along a straight axis (rook, queen)
        {
